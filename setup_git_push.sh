...
echo "  → Custom domain: zaangazowanie.covepolska.pl"
echo ""
echo "W DNS ustaw rekord:"
echo "  Type: CNAME"
echo "  Name/Host: zaangazowanie"
echo "  Value/Target: adeodatus11.github.io"
echo ""
echo "Strona będzie dostępna pod:"
echo "  https://zaangazowanie.covepolska.pl/"
